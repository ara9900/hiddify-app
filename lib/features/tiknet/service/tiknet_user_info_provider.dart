...
/// Connect + catalog free servers are allowed only while this is [TikNetEntitlement.allowed].
final tikNetEntitlementProvider = Provider<TikNetEntitlement>((ref) {
  if (!tikNetMode) return const TikNetEntitlement.allowed();
  return evaluateTikNetEntitlement(ref.watch(tikNetUserInfoProvider));
});
